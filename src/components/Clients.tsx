...
export function Clients() {
  ...
  return (
    <section
      ...
      className="border-b border-white/10 bg-brand-navyDeep py-14 lg:py-16">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <h2
          ...
          Las marcas que nos eligen
        </h2>
      </div>

      {reduce ?
        <ul className="mx-auto mt-9 grid max-w-7xl grid-cols-2 gap-x-8 gap-y-6 px-5 sm:grid-cols-3 lg:grid-cols-6 lg:px-8">
          {clients.map((client) =>
